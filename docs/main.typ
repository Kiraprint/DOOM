...
#figure(
  ...
  caption: [Сравнение потребления VRAM без gradient checkpointing и с ним. Слева — все активации хранятся (100% VRAM). Справа — активации не сохраняются, пересчитываются на backward (50% VRAM, +20-30% времени).],
) <fig-checkpoint>
